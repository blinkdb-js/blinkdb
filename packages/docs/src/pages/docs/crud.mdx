...
- You can add entities to the table (with [`insert()`](/docs/reference/insert) ),
- query entities within it (with [`first()`](/docs/reference/first), [`many()`](/docs/reference/many) & [`one()`](/docs/reference/one) ),
- update database entities (with [`update()`](/docs/reference/update) ),
- and delete them (with [`remove()`](/docs/reference/remove) ).
