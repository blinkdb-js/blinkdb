...
- You can add entities to the table (with [`insert()`](/docs/reference/insert) & [`insertMany()`](/docs/reference/insertMany)),
- query entities within it (with [`first()`](/docs/reference/first), [`many()`](/docs/reference/many) & [`one()`](/docs/reference/one)),
- update database entities (with [`update()`](/docs/reference/update), [`updateMany()`](/docs/reference/updateMany) & [`updateWhere()`](/docs/reference/updateWhere)),
